...
async function generatePDFInfoCentrees() {
    console.log('🚀 Génération du PDF avec informations centrées...');
    ...
    try {
        ...
        const pdfOptions = {
            path: 'offre-partenariat-info-centrees.pdf',
            format: 'A4',
        ...
        console.log('✅ PDF généré avec informations centrées : offre-partenariat-info-centrees.pdf');
...
function checkDependencies() {
    try {
        ...
        console.log('Puis : node generate-pdf-info-centrees.js');
        return false;
    }
}
...
if (checkDependencies()) {
    generatePDFInfoCentrees();
} else {
    console.log('\n📋 Instructions :');
    console.log('1. npm install puppeteer');
    console.log('2. node generate-pdf-info-centrees.js');
