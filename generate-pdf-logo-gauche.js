...
async function generatePDFLogoGauche() {
    console.log('🚀 Génération du PDF avec logo à gauche...');
    ...
    try {
        ...
        const pdfOptions = {
            path: 'offre-partenariat-logo-gauche.pdf',
            format: 'A4',
        ...
        console.log('✅ PDF généré avec logo à gauche : offre-partenariat-logo-gauche.pdf');
        console.log('📋 Caractéristiques :');
        console.log('   - Logo VIVIWORKS à gauche');
        console.log('   - OFFRE DE PARTENARIAT à droite');
        console.log('   - Pas de fond bleu');
        console.log('   - Texte en noir');
...
function checkDependencies() {
    try {
        ...
        console.log('Puis : node generate-pdf-logo-gauche.js');
        return false;
    }
}
...
if (checkDependencies()) {
    generatePDFLogoGauche();
} else {
    console.log('\n📋 Instructions :');
    console.log('1. npm install puppeteer');
    console.log('2. node generate-pdf-logo-gauche.js');
