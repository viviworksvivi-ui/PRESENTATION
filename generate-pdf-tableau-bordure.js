...
async function generatePDFTableauBordure() {
    console.log('🚀 Génération du PDF avec tableau à bordures complètes...');
    ...
    try {
        ...
        const pdfOptions = {
            path: 'offre-partenariat-tableau-bordure.pdf',
            format: 'A4',
        ...
        console.log('✅ PDF généré avec tableau à bordures : offre-partenariat-tableau-bordure.pdf');
        console.log('📋 Caractéristiques :');
        console.log('   - Logo VIVIWORKS à gauche');
        console.log('   - OFFRE DE PARTENARIAT à droite');
        console.log('   - Numéro, Date, Validité centrés par rapport au titre');
        console.log('   - Tableau avec bordures complètes');
        console.log('   - Lignes de séparation visibles');
...
function checkDependencies() {
    try {
        ...
        console.log('Puis : node generate-pdf-tableau-bordure.js');
        return false;
    }
}
...
if (checkDependencies()) {
    generatePDFTableauBordure();
} else {
    console.log('\n📋 Instructions :');
    console.log('1. npm install puppeteer');
    console.log('2. node generate-pdf-tableau-bordure.js');
